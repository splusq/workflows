...
{
    public static WorkflowDefinition BuildFluent(Assistant studentAgent, Assistant teacherAgent)
    {
        return
    ...
    public static WorkflowDefinition Build(Assistant studentAgent, Assistant teacherAgent)
    {
        var workflowBuilder =
            new WorkflowBuilder(name: "two_agent_math_chat", description: "2 way chat between student and teacher")
                .AddMessagesVariable(out var studentMessages, name: "studentMessages", description: "Messages from the student")
